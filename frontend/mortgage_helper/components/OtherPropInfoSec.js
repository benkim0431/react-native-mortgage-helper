...
function OtherPropInfoSec({Label, TextBox, info}) {
  ...
  return (
    <View style={styles.block}>
      ...
      <TextBox>
        <Label>Annual Taxes: </Label>${info[0] == undefined ? "" : info[0].annualPropertyTaxes}
      </TextBox>
      <TextBox>
        <Label>Property Fees: </Label>${info[0] == undefined ? "" : info[0].value}
      </TextBox>
      <TextBox>
        <Label>Monthly Payment: </Label>${info[0] == undefined ? "" : info[0].monthlyPayment}
      </TextBox>
    </View>
  );
}
